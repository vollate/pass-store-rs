...
Define composition boundaries for hand-written Flutter GUI screens so large
screens stay focused, testable, and behavior-equivalent while UI surfaces are
split into screen-local widgets.
